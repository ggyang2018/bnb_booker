...
public class HTMLProcessor
{
   ...
   public HashMap<String, String> getContext(){return Mapping;}
   ...
   protected String getTagContext(String s) throws IOException
   {
		int bin = s.indexOf('<');
		int end = s.indexOf('>');
   ...
   private String getQuotaContext(String s) throws IOException
   {
	   //must be in one line
	    int bin = s.indexOf('\"');
	...
	protected int stateTag(String s)
	{
	  if(s.indexOf("</")>=0)
	 	 return 1;
	...
	boolean hasVariable(String str, char reg)
	{
	 ...
	 private String getSearchKey(String s)
	 {
	 ...
	 public Vector<String> getKeyVector( )
	 {
